...
rf_model_filename = "C:\\Users\\hp\\Desktop\\ML-Script\\new-rf-8class-model.pkl"
with open(rf_model_filename, "rb") as model_file:
    model = pickle.load(model_file)

# Define the input CSV file for testing
test_file = 'C:\\Users\\hp\\Desktop\\ML-Script\\pcapTes.csv'  # Replace with the path to your test CSV file
...
output_file = 'predictionsTest8.csv'  # Replace with the desired output file path
